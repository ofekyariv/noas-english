          ...
          >
            <div className="bg-gradient-to-br from-teal-400 to-cyan-500 rounded-3xl shadow-xl p-8 text-center text-white">
              <p className="text-sm font-bold opacity-80 mb-2">
                Digraph {introIdx + 1} of {digraphs.basic.length}
              </p>
              ...
              <p className="text-sm opacity-75 mb-6">
                Two letters make ONE sound: &ldquo;
                {digraphs.basic[introIdx].digraph}&rdquo;
              </p>
              <button
                ...
                className="bg-white text-teal-600 font-black text-lg px-8 py-3 rounded-2xl
                  ...
                  transition-all"
              >
                {introIdx + 1 < digraphs.basic.length ? "Next ➡️" : "Let's Quiz! 🎯"}
              </button>
            </div>
          </motion.div>
        )}
          ...
          >
            <div className="bg-gradient-to-br from-yellow-400 to-orange-400 rounded-3xl shadow-xl p-8 text-center text-white mb-4">
              <p className="text-sm font-bold opacity-80 mb-1">
                🎵 The &ldquo;EE&rdquo; sound!
              </p>
              <div className="bg-white/20 rounded-2xl px-4 py-2 mb-4 inline-block">
                <span className="text-4xl font-black">ee</span>
              </div>
              <div className="text-7xl mb-3">{digraphs.ee[eeIdx].emoji}</div>
              <p className="text-4xl font-black mb-1">{digraphs.ee[eeIdx].word}</p>
              <p className="text-sm opacity-75 mb-6">
                Hear the &ldquo;ee&rdquo; sound? 👂
              </p>
              <button
                ...
                className="bg-white text-orange-600 font-black text-lg px-8 py-3 rounded-2xl
                  ...
                  transition-all"
              >
                {eeIdx + 1 < digraphs.ee.length ? "Next ➡️" : "Finish! 🎉"}
              </button>
            </div>
            <p className="text-center text-gray-400 font-semibold text-sm">
              {eeIdx + 1} / {digraphs.ee.length} ee words
            </p>
          </motion.div>
        )}
      </AnimatePresence>
